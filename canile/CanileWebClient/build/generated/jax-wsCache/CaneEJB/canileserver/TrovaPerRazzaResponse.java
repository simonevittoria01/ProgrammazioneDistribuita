...
/**
 * <p>Classe Java per trovaPerRazzaResponse complex type.</p>
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.</p>
 * 
 * <pre>{@code
 * <complexType name="trovaPerRazzaResponse">
 *   <complexContent>
...
@XmlType(name = "trovaPerRazzaResponse", propOrder = {
    "_return"
})
public class TrovaPerRazzaResponse {
